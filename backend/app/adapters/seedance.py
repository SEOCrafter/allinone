...
class SeedanceAdapter(BaseAdapter):
    ...
    PRICING = {
        ...
        "bytedance/seedream-3.0": {"per_image": 0.02, "display_name": "Seedream 3.0"},
        "bytedance/seedream-4.0": {"per_image": 0.03, "display_name": "Seedream 4.0"},
    }
            ...
            try:
                async with httpx.AsyncClient(timeout=30.0) as client:
                    ...
                    if status in ["success", "completed"]:
                        ...
                        result_url = output.get("video_url") or output.get("image_url") or output.get("url")
                        return GenerationResult(success=True, content=result_url)
    ...
    def calculate_cost(self, model: Optional[str] = None, **params) -> float:
        ...
        return pricing.get("per_video", pricing.get("per_image", 0.40))

...
export const MODELS: Model[] = [
  ...
  },
  {
    ...
    shortName: 'T2V Standard',
    description: 'Стандартная генерация видео из текста',
    category: 'video',
    taskType: 't2v',
    cost: 35,
    rating: 4.85,
  ...
  },
  {
    ...
    shortName: 'T2V Pro',
    description: 'Профессиональная генерация видео из текста',
    category: 'video',
    taskType: 't2v',
    cost: 35,
    rating: 4.88,
  ...
  },
  {
    ...
    shortName: 'I2V Standard',
    description: 'Стандартная генерация видео из изображения',
    category: 'video',
    taskType: 'i2v',
    cost: 35,
    rating: 4.84,
    ...
    icon: '/icons/hailuo.svg',
    color: '#3b82f6',
    backendModel: 'hailuo/02-image-to-video-standard',
    requiresImage: true,
    supportsPromptOptimizer: true,
    aspectRatios: ['16:9', '9:16', '1:1'],
    durations: ['5'],
  },
  {
    ...
    shortName: 'I2V Pro',
    description: 'Профессиональная генерация видео из изображения',
    category: 'video',
    taskType: 'i2v',
    cost: 35,
    rating: 4.87,
    ...
    icon: '/icons/hailuo.svg',
    color: '#3b82f6',
    backendModel: 'hailuo/02-image-to-video-pro',
    requiresImage: true,
    supportsPromptOptimizer: true,
    aspectRatios: ['16:9', '9:16', '1:1'],
    durations: ['5'],

...
export const MODELS: Model[] = [
  ...
  },
  {
    ...
    icon: '🍌',
    color: '#eab308',
    backendModel: 'nanobanana-standard'
  },
  {
    id: 'midjourney-t2i',
    provider: 'midjourney',
  ...
  },
  {
    ...
    icon: '🕺',
    color: '#22c55e',
    backendModel: 'kling-motion-control'
  }
]
